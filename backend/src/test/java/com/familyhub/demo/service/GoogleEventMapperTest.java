...
class GoogleEventMapperTest {
    ...
    void setUp() {
        ...
        family.setTimezone("America/New_York");
    ...
    class ToEntity {
        ...
        @Test
        void mapsUtcTimedEventInFamilyTimezone() {
            Event googleEvent = new Event();
            googleEvent.setId("utc-event-123");
            googleEvent.setSummary("Subscribed Calendar Event");
            googleEvent.setStart(new EventDateTime()
                    .setDateTime(new DateTime("2025-06-15T13:00:00Z")));
            googleEvent.setEnd(new EventDateTime()
                    .setDateTime(new DateTime("2025-06-15T14:30:00Z")));
